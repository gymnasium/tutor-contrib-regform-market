...
hooks.Filters.CONFIG_DEFAULTS.add_items(
    [
        ...
        # Prefix your setting names with 'MARKET_REGFORM_'.
        ("MARKET_REGFORM_VERSION", __version__),
    ]
)
...
hooks.Filters.CONFIG_UNIQUE.add_items(
    [
        ...
        # Prefix your setting names with 'MARKET_REGFORM_'.
        # For example:
        ### ("MARKET_REGFORM_SECRET_KEY", "{{ 24|random_string }}"),
    ]
)
...
#   $ tutor local do say-hi --name="Roman Edirisinghe"
